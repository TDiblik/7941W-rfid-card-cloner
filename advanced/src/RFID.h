...
#define MAX_POSSIBLE_RW_RESPONSE_LEN 100 // Theoretically, we'll never need more than 20 byte, however I want some leeway
...
private:
    ...
    uint8_t __rw_response_buf[MAX_POSSIBLE_RW_RESPONSE_LEN];
    uint8_t __rw_response_buf_len;
    RFIDResponse _read_rw_response_into_buf();
